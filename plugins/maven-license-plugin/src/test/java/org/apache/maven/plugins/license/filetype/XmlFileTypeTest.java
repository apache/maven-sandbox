 ...
 * @version $Id$
 */
public class XmlFileTypeTest
    extends AbstractFileTypeTestCase
{
    public XmlFileTypeTest()
    {
        super( "xml" );
    }
        ...
        throws IOException, LicenseCheckException
    {
        ...
        File unsetFile = getSourceFile( "inject-1.xml" );
        File expectedFile = getSourceFile( "inject-1-expected.xml" );
    ...
    public void testInject1()
        throws Exception
    {
        File injectFile = getTestInjectFile( "inject-1.xml" );
        String rawLicense = getRawLicense();

        filetype.injectLicense( injectFile, rawLicense );

        String expectedContents = getTestFileContents( "inject-1-expected.xml" );
