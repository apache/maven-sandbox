    ...
    extends AbstractFileTypeTestCase
{
        ...
        throws IOException, LicenseCheckException
    {
        ...
        File unsetFile = getSourceFile( "inject-1.html" );
        File expectedFile = getSourceFile( "inject-1-expected.html" );
    ...
    public void testInject1()
        throws Exception
    {
        File injectFile = getTestInjectFile( "inject-1.html" );
        String rawLicense = getRawLicense();

        filetype.injectLicense( injectFile, rawLicense );

        String expectedContents = getTestFileContents( "inject-1-expected.html" );
