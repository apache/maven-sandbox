 ...
 * @version $Id$
 */
public class JavaFileTypeTest
    extends AbstractFileTypeTestCase
{
    public JavaFileTypeTest()
    {
        super( "java" );
    }
        ...
        throws IOException, LicenseCheckException
    {
        ...
        File unsetFile = getSourceFile( "inject-1.java" );
        File expectedFile = getSourceFile( "inject-1-expected.java" );
    ...
    public void testInject1()
        throws Exception
    {
        File injectFile = getTestInjectFile( "inject-1.java" );
        String rawLicense = getRawLicense();

        filetype.injectLicense( injectFile, rawLicense );

        String expectedContents = getTestFileContents( "inject-1-expected.java" );
