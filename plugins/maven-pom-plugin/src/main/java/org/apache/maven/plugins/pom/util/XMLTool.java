 ...
 * @version $Id: XMLReader.java 532767 2007-04-26 14:57:16Z joakime $
 */
public class XMLTool
{
    ...
    public XMLTool( String type, File file )
        throws XMLException
    {
        if ( !file.exists() )
        {
    ...
    public XMLTool( String type, URL url )
        throws XMLException
    {
        init( type, url );
    }
        ...
        throws XMLException
    {
        ...
        else
        {
            ...
            throw new XMLException( ".getElement( " + xpathExpr + " ) resulted in non-Element type -> ("
    ...
    public void updateElement( String xpathExpr, String value ) throws XMLException
    {
        Element element = getElement( xpathExpr );
    ...
    public void writeDocument( String file ) throws XMLException
    {
        try 
        {                   
            XMLWriter.write( document, new FileWriter( file ) );
        }
        catch ( IOException ioe )
        {
            throw new XMLException( "error with writing to file: " + file, ioe );            
        }
    }

    public void writeDocument() throws XMLException
    {
        writeDocument( sourceFile );
    }
}
