    ...
    extends AbstractMavenReport
{
    ...
    {
        return i18n.getString( "assembly-plugin", locale, "report.download.name" );
    }
    ...
    {
        return i18n.getString( "assembly-plugin", locale, "report.download.description" );
    }
        ...
        throws MavenReportException
    {
        ...
        try
        {
            DownloadRenderer r = new DownloadRenderer( getSink(), getProject(), i18n, locale, ( StringUtils
        ...
        extends AbstractMavenReportRenderer
    {
         ...
         */
        public DownloadRenderer( Sink sink, MavenProject project, I18N i18n, Locale locale, String downloadUrl,
        ...
        {
            return i18n.getString( "assembly-plugin", locale, "report.download.title" ) + " " + (
        ...
        public void renderBody()
        {
            ...
            if ( ( distributionFileNames == null ) || ( distributionFileNames.isEmpty() ) )
            {
                paragraph( i18n.getString( "assembly-plugin", locale, "report.download.notavailable" ) );
            ...
            sink.paragraph();
            linkPatternedText( i18n.getString( "assembly-plugin", locale, "report.download.intro" ) );
            sink.paragraph_();
