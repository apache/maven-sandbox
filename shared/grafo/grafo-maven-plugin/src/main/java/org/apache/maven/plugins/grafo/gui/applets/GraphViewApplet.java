...
import org.apache.maven.plugins.grafo.gui.GraphView;

import prefuse.util.ui.JPrefuseApplet;

/**
 * Applet that shows a graph from the xml input specified in the applet parameter
 ...
 * </code>
 * 
 * @see org.apache.maven.plugins.grafo.gui.GraphView
 * 
 * @author <a href="mailto:carlos@apache.org">Carlos Sanchez</a>
 * @version $Id$
 */
public class GraphViewApplet
    extends JPrefuseApplet
{
    ...
    public void init()
    {
        ...
        this.setContentPane( GraphView.demo( datafile, label ) );
    }
