...
public class AccuRevCommandLine implements AccuRev {
    ...
    private boolean executeCommandLine(File basedir, String[] args, Iterable<File> elements, StreamConsumer stdoutConsumer)
    ...
    private boolean executeCommandLine(String[] args, InputStream stdin, StreamConsumer stdout) throws AccuRevException {
    ...
    private boolean executeCommandLine(InputStream stdin, StreamConsumer stdout) throws AccuRevException {
     ...
     * {@inheritDoc}
     */
    public boolean update(File baseDir, String transactionId, List<File> updatedFiles) throws AccuRevException {
     ...
     * {@inheritDoc}
     */
    public boolean add(File basedir, List<File> elements, String message, List<File> addedFiles) throws AccuRevException {
    ...
    public boolean defunct(File basedir, List<File> files, String message, List<File> defunctedFiles) throws AccuRevException {
	if (StringUtils.isBlank(message)) {
	...
	return executeCommandLine(basedir, new String[] { "defunct", "-c", message }, files, FileConsumer.DEFUNCT_PATTERN,
		defunctedFiles);
    }

    public boolean promote(File basedir, List<File> files, String message, List<File> promotedFiles) throws AccuRevException {
	if (StringUtils.isBlank(message)) {
	    message = AccuRev.DEFAULT_PROMOTE_MESSAGE;
	}
	return executeCommandLine(basedir, new String[] { "promote", "-K", "-c", message }, files, FileConsumer.PROMOTE_PATTERN,
		promotedFiles);
     ...
     * {@inheritDoc}
     */
    public boolean promoteAll(File baseDir, String commitMessage, List<File> promotedFiles) throws AccuRevException {
	setWorkingDirectory(baseDir);
    ...
    public boolean statTag(String streamName, List<File> taggedFiles) throws AccuRevException {
	return executeCommandLine(null, new String[] { "stat", "-a", "-ffl", "-s", streamName }, null, FileConsumer.STAT_PATTERN,
		taggedFiles);
    }
    ...
    public boolean pop(File basedir, Collection<File> elements, List<File> poppedFiles) throws AccuRevException {
    ...
    public boolean pop(File basedir, String versionSpec, Collection<File> elements, List<File> poppedFiles) throws AccuRevException {
    ...
    public boolean statBackingStream(File basedir, Collection<File> elements, Collection<File> memberElements,
	    Collection<File> nonMemberElements) throws AccuRevException {
	if (elements.isEmpty()) {
	    return true;
	}
    ...
    public boolean history(String baseStream, String fromTimeSpec, String toTimeSpec, int count, List<Transaction> transactions)
	    throws AccuRevException {
    ...
    public boolean showRefTrees(Map<String, WorkSpace> workSpaces) throws AccuRevException {
    ...
    public boolean showWorkSpaces(Map<String, WorkSpace> workSpaces) throws AccuRevException {
	String[] show = { "show", "-a", "-fx", "wspaces" };
	WorkSpaceConsumer stdout = new WorkSpaceConsumer(getLogger(), workSpaces);
	return executeCommandLine(show, null, stdout);
    }

    public static void main(String[] args) throws AccuRevException {
