...
public class AccuRevScmProvider extends AbstractScmProvider {
    ...
    /**
     * The basic url parsing approach is to be as loose as possible. If you specify as per the docs you'll get what you expect. If
     * you do something else the result is undefined. Don't use "/" "\" or "@" as the delimiter,
     */
